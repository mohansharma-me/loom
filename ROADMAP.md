...
- [x] **Testing strategy and infrastructure** — [#49](https://github.com/mohansharma-me/loom/issues/49) `CC-01`
- [x] **Structured logging and observability conventions** — [#50](https://github.com/mohansharma-me/loom/issues/50) `CC-02`
- [x] **Type specs and Dialyzer compliance** — [#51](https://github.com/mohansharma-me/loom/issues/51) `CC-03`
...
- [x] Integration test suite for real vLLM on GPU hardware — [#15](https://github.com/mohansharma-me/loom/issues/15) `P0-14`
- [x] Phase 0 architecture docs and demo script — [#16](https://github.com/mohansharma-me/loom/issues/16) `P0-15`
